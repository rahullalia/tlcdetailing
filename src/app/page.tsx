    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          <a
            href={PHONE_LINK}
            className="group relative w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-amber-400 text-black font-bold text-lg overflow-hidden magnetic-btn"
          >
